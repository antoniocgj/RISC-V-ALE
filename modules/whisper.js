...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5328096,
    DYNAMIC_BASE = 5328096,
    DYNAMICTOP_PTR = 85024;
...
function _readInteractiveCommand(){ var jsString = getInteractiveCommand(); var lengthBytes = lengthBytesUTF8(jsString)+1; var stringOnWasmHeap = _malloc(lengthBytes); stringToUTF8(jsString, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap; }
...
var ___em_js__readInteractiveCommand = Module["___em_js__readInteractiveCommand"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__readInteractiveCommand"].apply(null, arguments)
};
